...
namespace ShopTask.DataAccess.Repositories
{
    public class CategoriesRepository : IRepository<Category>
    {
        ...
        public async Task<IEnumerable<Category>> GetAll(Expression<Func<Category, object>> include = null)
        {
        ...
        public async Task<IEnumerable<Category>> Find(Expression<Func<Category, bool>> where, Expression<Func<Category, object>> include = null)
        {
